// ── PROJECTS DATA ──────────────────────────────────────────────────────────────
const PROJECTS = {
  wildway:  { name:'Wild Way',          cat_pt:'Branding · Identidade Visual', cat_en:'Branding · Visual Identity',  desc_pt:'Equipamentos de camping & aventura. Identidade visual completa com logotipo, sistema de cores, tipografia, aplicações em produtos e redes sociais estruturadas.', desc_en:'Camping & adventure equipment. Full visual identity with logo, color system, typography, product applications and structured social media.', tags:['Logotipo','Brand System','Embalagem','Redes Sociais'], bg:'linear-gradient(135deg,#0a1c0a,#162a18)', glow:'rgba(30,140,30,.4)' },
